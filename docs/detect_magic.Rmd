...
No creature is inherently detected by Detect Magic, however some creatures have magical abilities or features that can be picked up by the spell.

#### Does Detect Magic detect the familiar from find familiar?

No - that would be detect evil and good.

- Unless that familiar is invisible or has some other magical effect on them.
...
No - It detects a magical presence if someone invisible is nearby, but you cannot see them because the aura can only be present on an already visible creature/object.
